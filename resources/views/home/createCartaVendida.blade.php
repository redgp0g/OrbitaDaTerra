                ...
                <form method="POST" action="{{ url('cartaVendida') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="text" id="Celular" name="Celular" class="form-control celular" required>
                        </div>
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="text" id="ValorPago" name="ValorPago" class="form-control" data-type="currency"
                                placeholder="R$1.000,00" required />
                        </div>
                        <div class="form-group col-lg-2">
                            <label class="form-label" for="ValorVendaDesejada">Valor de Venda Desejada<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="ValorVendaDesejada" name="ValorVendaDesejada" class="form-control"
                                data-type="currency" placeholder="R$1.000,00" required />
                        </div>
                        <div class="form-group col-lg-2">
                        ...
                        <div class="form-group col-lg-2">
                            <label class="form-label" for="ComissaoAutorizada">Comissão da Autorizada <span
                                    class="text-danger">*</span></label>
                            <input type="text" id="ComissaoAutorizada" name="ComissaoAutorizada" class="form-control"
                                required>
                        </div>
                        <div class="form-group col-lg-2">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="hidden" name="IDEmpresaAutorizada" value="{{ $autorizada->IDEmpresa }}" />
