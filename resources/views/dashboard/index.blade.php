        ...
        <div class="card" data-aos="fade-up" data-aos-delay="800">
          <div class="mb-4 flex-wrap card-header d-flex justify-content-between align-items-center">
            <div class="header-title d-flex">
              ...
              <svg class="icon-32 d-none" id="fecharFormNovoLead" style="cursor: pointer" onclick="abrirFecharFormNovoLead()" width="32" viewBox="0 0 24 24"
                fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.4"
                  ...
                  <form id="formCadastrarLead" method="post" action="{{ url('/api/cadastros') }}">
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input class="form-control" name="Nome" type="text" placeholder="Nome do lead" required>
                      </div>
                    ...
                    @if (auth()->user()->Cadastro->TipoCadastro == 'Vendedor')
                      <input name="IDCadastroVendedor" type="hidden" value="{{ auth()->user()->IDCadastro }}">
                    @else
                      <input name="IDCadastroVendedor" type="hidden" value="{{ auth()->user()->cadastro->IDCadastroVendedorIndicado }}">
                    @endif
                    <input name="IDCadastroIndicador" type="hidden" value="{{ auth()->user()->IDCadastro }}">
          ...
          <tbody>
            @foreach ($leads as $lead)
              ...
              <tr>
                ...
                <td>
                  <button class="btn-enviar-mensagem border-0 bg-transparent" data-nomelead="{{ $primeiroNomeLead }}" data-telefonelead="{{ $telefone }}"
                  ...
                  <button class="editar-lead btn btn-warning" data-id="{{ $lead->IDCadastro }}">Editar</button>
                  <button class="btn btn-danger delete-lead" data-id="{{ $lead->IDCadastro }}">Deletar</button>
                </td>
              </tr>
            @endforeach
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button class="close" data-dismiss="modal" type="button" aria-label="Close" onclick="modalEditarLead.modal('hide')">
        ...
        <div class="modal-body">
          <form id="formEditarLead">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="previsaoAtividadeVendedor-edit" name="PrevisaoAtividadeVendedor" type="date">
            </div>
            <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <button class="close" data-dismiss="modal" type="button" aria-label="Close" onclick="modalEnviarMensagem.modal('hide')">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
...
Aguardo seu contato!</textarea>
            ...
            <button class="btn btn-success link-whatsapp" data-textareaid="mensagemPadrao1">Enviar Mensagem Padrão 1</button>
          </div>
          <div class="card">
            <div class="form-group py-6">
...
Aguardo seu contato!</textarea>
            ...
            <button class="btn btn-success link-whatsapp" data-textareaid="mensagemComIndicador">Enviar Mensagem com Indicador</button>
          </div>
        </div>
      </div>
    </div>
