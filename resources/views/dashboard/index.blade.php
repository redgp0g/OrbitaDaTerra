                            ...
                            <div class="card" data-aos="fade-up" data-aos-delay="800">
                                <div class="mb-4 flex-wrap card-header d-flex justify-content-between align-items-center">
                                    <div class="header-title d-flex">
                                        ...
                                        <svg id="abrirFormNovoLead" class="icon-32 cursor-pointer"
                                            onclick="abrirFecharFormNovoLead()" style="cursor: pointer" width="32"
                                        ...
                                        <svg id="fecharFormNovoLead" class="icon-32 d-none" style="cursor: pointer"
                                            onclick="abrirFecharFormNovoLead()" width="32" viewBox="0 0 24 24"
                            ...
                            <table id="table" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($leadsIndicados as $leadIndicado) {
                                        ...
                                        echo '<td>' . $telefone . '</td>';
                                        echo '<td>' . $leadIndicado->AtividadeVendedor . '</td>';
                                        echo '<td>' . $leadIndicado->PrevisaoAtividadeVendedor . '</td>';
                                        echo '<td></td>';
                                        echo '<td></td>';
                                        echo '</tr>';
                                    }
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal"
                            onclick="modalEditarLead.modal('hide')" aria-label="Close">
