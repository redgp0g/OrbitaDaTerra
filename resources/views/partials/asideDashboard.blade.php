<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all sidebar-mini">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="/public/index.php/dashboard" class="navbar-brand">
            <div class="logo-main">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-consultar" role="button" aria-expanded="false" aria-controls="sidebar-consultar">
                        <i class="icon">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-consultar" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="/public/index.php/dashboard">
                                <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-consultar" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/public/index.php/dashboard/contas">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-consultar" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/public/index.php/dashboard/historicoAcesso">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-consultar" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/public/index.php/dashboard/indexEmpresa">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-cadastrar" role="button" aria-expanded="false" aria-controls="sidebar-cadastrar">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-cadastrar" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/public/index.php/dashboard/createEmpresa">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-cadastrar" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="/public/index.php/dashboard/createCartaVendida">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
